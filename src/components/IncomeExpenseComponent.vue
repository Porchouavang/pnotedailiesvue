                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-between">
                            <button class="btn btn-danger" data-toggle="modal" data-target="#modal-add-expense"><i
                                ...
                                <router-link to="/expense_details" class="btn btn-danger"><i class="fas fa-arrow-circle-right mr-2"></i>ລາຍລະອຽດ</router-link>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr v-else v-for="(expenses, index) in expenses_s" :key="expenses.id">
                                        ...
                                        <td>
                                            <button @click="ShowExpenseItem(expenses.id)" class="btn btn-warning"
                                                data-toggle="modal" data-target="#modal-edit-expense"><i
                                                    class="fas fa-edit"></i></button>
                                            <button @click="ConfirmDelete(expenses.id)" href="" class="btn btn-danger"><i
                                                    class="fas fa-times"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <form enctype="multipart/form-data" @submit.prevent="CreateExpense">
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group ml-4 mb-3">
                                            <label for="exampleInputEmail1">ເຫດຜົນທີ່ໃຊ້:<span
                                                    class="text-danger">*</span></label>
...
export default {
    ...
    methods: {
        ...
        async ShowIncome() {
            try {
                const response = await axios.get('https://nodejsbackenddailies.onrender.com/api/select-income');
        ...
        async ShowExpense() {
            try {
                const response = await axios.get('https://nodejsbackenddailies.onrender.com/api/select-expense');
                if (Array.isArray(response.data)) {
        ...
        async CreateIncome() {
            try {
                const response = await axios.post('https://nodejsbackenddailies.onrender.com/api/create-income', {
                    income: this.income,
        ...
        async CreateExpense() {
            try {
                const response = await axios.post('https://nodejsbackenddailies.onrender.com/api/create-expense', {
        ...
        async DeleteIncome(Income_ID) {
            try {
                const response = await axios.delete(`https://nodejsbackenddailies.onrender.com/api/delete-income/${Income_ID}`);
                console.log(response.data);
                Swal.fire({
                    title: 'ລົບລ້າງ!',
        ...
        async DeleteExpense(Expense_ID) {
            try {
                const response = await axios.delete(`https://nodejsbackenddailies.onrender.com/api/delete-expense/${Expense_ID}`);
                console.log(response.data);
                Swal.fire({
                    title: 'ລົບລ້າງ!',
                    text: 'ຂໍ້ມູນໄດ້ຖືກລຶບສຳເລັດແລ້ວ',
        ...
        async SearchIncome() {
            ...
            fetch(`https://nodejsbackenddailies.onrender.com/api/search-income?${params.toString()}`)
        ...
        async SearchExpense() {
            ...
            fetch(`https://nodejsbackenddailies.onrender.com/api/search-expense?${params.toString()}`)
                .then((response) => response.json())
                .then((data) => {
        ...
        async ShowIncomeItem(Income_ID) {
            ...
            try {
                const response = await axios.get(`https://nodejsbackenddailies.onrender.com/api/income/${Income_ID}`);
        ...
        async ShowExpenseItem(Expense_ID) {
            ...
            try {
                const response = await axios.get(`https://nodejsbackenddailies.onrender.com/api/expense/${Expense_ID}`);
        ...
        async UpdateIncome() {
            try {
                const response = await axios.put(`https://nodejsbackenddailies.onrender.com/api/update-income/${this.Income_ID}`, {
        ...
        async UpdateExpense() {
            try {
                const response = await axios.put(`https://nodejsbackenddailies.onrender.com/api/update-expense/${this.Expense_ID}`, {
